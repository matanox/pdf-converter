...
var UnplausiblyAbstract, analytic, assert, createIndex, css, ctype, dataWriter, done, fs, generateFromHtml, headers, html, iterator, logging, markers, mode, refactorMode, refactorTools, sentenceSplitter, timer, titleAndAbstract, util, xml;
