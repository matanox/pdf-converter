...
var analytic, assert, createIndex, css, ctype, dataWriter, done, fs, generateFromHtml, html, iterator, logging, markers, mode, model, output, refactorMode, refactorTools, sentenceSplitter, timer, titleAndAbstract, util, verbex;
