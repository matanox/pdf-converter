...
'use strict';
var app, authorization, cluster, env, errorHandling, express, fs, host, http, logging, nconf, numCPUs, path, port, primus, routes, selfMonitor, spawnClusterWorkers, startServer, util;
