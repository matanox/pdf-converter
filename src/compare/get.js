...
var diffFormat, docsDataDir, fs, getPair, intraLineFormat, iterator, jsdiff, logging, pad, util, wrappedWordsDiff;
...
wrappedWordsDiff = function(string1, string2) {
  var newlineReplacer, replace, replaceDoubleSpaces, replacements, spaceReplacer, string1r, string2r, wordsDiff;
