...
var enableContext, go, loadArticleText, markRemove, myAjax, reload, remove, renderText, selection, startAfterPrerequisites, tokenSequence, userEventMgmt, userEventMgmtEnabled;

selection = null;

markRemove = function() {
  var element, id, _i, _len, _results;
  ...
  if (selection != null) {
    ...
    for (_i = 0, _len = selection.length; _i < _len; _i++) {
      ...
      _results.push($('#popover').popover('hide'));
    }
    return _results;
  } else {
...
userEventMgmt = function() {
  var Color, addElement, baseMarkColor, buttonGroupHtml, container, contextmenuHandler, dragElements, endDrag, fluffChooser, fluffChooserDisplay, fluffChooserDisplayOld, inDrag, inDragMaybe, inTouch, leftDown, leftDrag, logDrag, mark, mousemoveHandler, noColor, page, rightDown, rightDrag, touchmoveHandler;
