...
var crypto, docMeta, exec, executable, executalbeParams, fs, logging, redirectToExtract, redirectToShowHtml, riak, storage, util;
...
exports.go = function(localCopy, docLogger, req, res) {
  ...
  return riak.get('html', hash, function(error, formerName) {
    ...
    if (error != null) {
      ...
      return require('./extract').go(req, formerName, res, docLogger, output.serveViewerTemplate);
    }
  });
};
