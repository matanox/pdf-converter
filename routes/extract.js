...
var analytic, css, ctype, deriveStructure, deriveStructureWithValues, done, filterImages, filterZeroLengthText, fs, generateFromHtml, html, isImage, iterator, logging, markers, model, output, timer, titleAndAbstract, util, verbex;
...
exports.originalGo = function(req, name, res, docLogger) {
  ...
  return console.log('finished generating tokens');
};
