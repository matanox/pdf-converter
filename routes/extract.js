...
var css, ctype, filterImages, filterZeroLengthText, html, isImage, markers, model, output, timer, util;
...
exports.go = function(req, res) {
  ...
  util.timelog('Index creation');
  useMarkers = function() {
    var addStyle, marker, markerMatch, mi, textFromIndex, tii;
    markerMatch = function() {
      return false;
    };
    addStyle = function(textFromIndex) {
      return false;
    };
    ...
    while (tii < textIndex.length && mi < markers.markers.array.length) {
    ...
    return util.timelog('Markers visualization');
  };
