...
var analytic, css, ctype, filterImages, filterZeroLengthText, fs, generateFromHtml, html, isImage, iterator, logging, markers, model, output, riak, storage, timer, titleAndAbstract, util, verbex;
...
generateFromHtml = function(req, name, res, docLogger) {
...
exports.go = function(req, name, res, docLogger) {
  ...
  return storage.fetch('tokens', name, function(cachedTokens) {
    ...
    if (cachedTokens) {
      ...
      return generateFromHtml(req, name, res, docLogger);
    }
  });
};
