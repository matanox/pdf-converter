...
var analytic, assert, css, ctype, deriveStructure, deriveStructureWithValues, fs, generateFromHtml, html, iterator, logging, markers, model, output, respond, timer, titleAndAbstract, util, verbex;
...
generateFromHtml = function(req, name, res, docLogger, callback) {
  ...
  */
  ...
  deriveStructure(tokens);
  return deriveStructureWithValues(tokens);
};
